...
import org.molgenis.selenide.model.importer.ImporterModel.EntitiesOptions;
...
public class ImporterTest extends AbstractSeleniumTest
{
	...
	public void xlsx() throws IOException, InterruptedException
	{
		...
		File xlsxFile = ImporterModel.getFile("org/molgenis/selenide/emx/xlsx/emx_all_datatypes.xlsx");
	...
	public void csvZip() throws IOException, InterruptedException
	{
		...
		File csvZipFile = ImporterModel.getFile("org/molgenis/selenide/emx/csv.zip/emx_all_datatypes_csv.zip");
