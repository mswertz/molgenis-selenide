...
import org.molgenis.selenide.model.mappingservice.AlgorithmEditorModel;
import org.molgenis.selenide.model.mappingservice.MappingProjectDetailsModel;
...
public class MappingProjectDetailsTest extends AbstractSeleniumTest
{
	...
	public void beforeClass()
	{
		...
		importEMXFiles("org/molgenis/selenide/mappingservice/mappingservice-test.xlsx",
				"org/molgenis/selenide/mappingservice/biobank_ontology_test.owl.zip",
				"org/molgenis/selenide/mappingservice/uo_test.owl.zip",
				"org/molgenis/selenide/mappingservice/test-javascript_magma.xls");
	...
	public void testMapLifelinesToHop()
	{
		...
		Selenide.sleep(5000); //time to generate the set (should have handle to waitFor)
